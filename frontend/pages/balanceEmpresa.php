...
<body class="sb-nav-fixed">
                  ...
                  <form id="formAgregarBalance">
                    ...
                    <div class="mb-3">
                      ...
                      <select class="form-select" id="tipoBalance" name="tipoBalance" required>
                        ...
                        <option value="ingresos">Cotizaciones</option>
          ...
          <div class="table-responsive my-4">
            <table class="table table-striped table-bordered">
              ...
              <tbody id="tablaBalance">
                ...
                <tr>
                  <td>Total Ingresos por Servicios</td>
                  <td>Cotizaciones</td>
                  <td>Mayo 2025</td>
                  <td>S/. 25,800.00</td>
                  <td>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', () => {
      ...
      let balances = [
        { id: 1, nombre: 'Balance General Mensual', tipo: 'Alquileres', mes: '2025-05', monto: 15250.70 },
        { id: 2, nombre: 'Total Ingresos por Servicios', tipo: 'Cotizaciones', mes: '2025-05', monto: 25800.00 }
      ];
