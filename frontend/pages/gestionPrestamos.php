        ...
        <div class="container-fluid px-4">
          ...
          <div class="row">
            <div class="col-12 d-flex justify-content-between align-items-center">
              <div class="d-flex">
                <input type="text" class="form-control me-2" id="buscarServicio" placeholder="Buscar Préstamo">
                <button class="btn btn-primary" id="btnBuscar">Buscar</button>
              </div>
              <?php if ($_SESSION['rol'] === 'Administrador'): ?>
              <div>
                <a href="#" class="btn btn-success me-2" data-bs-toggle="modal" data-bs-target="#modalPagoPrestamo">Vista Pago Préstamo</a>
         ...
         <!-- Modal Agregar -->
          ...
          <div class="modal fade" id="modalPagoPrestamo" tabindex="-1" aria-labelledby="modalPagoPrestamoLabel" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="modalPagoPrestamoLabel">Registrar Pago de Préstamo</h5>
                ...
                <div class="modal-body">
                  <form id="formPagoPrestamo">
                    ...
                    <div class="mb-3">
                      <label for="fechaPago" class="form-label fw-bold">Fecha de Pago:</label>
            ...
            <table class="table table-striped table-bordered">
              ...
              <tbody id="tablaDeudas">
                ...
                <tr id="filaEjemplo">
                  ...
                  <td>01-06-2025</td>
                  <td>
                    <button class="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#modalEditarDeuda">Editar</button>
                    <button class="btn btn-sm btn-danger">Eliminar</button>
                  </td>
                </tr>
                <!-- Fila para cuando no hay datos -->
                <tr id="sinDatos" style="display: none;">
