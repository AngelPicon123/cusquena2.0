                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="formEditarGasto">
                                        ...
                                        <div class="mb-3">
                                            <label for="editTipoGasto" class="form-label fw-bold">Tipo de Gasto:</label>
                                            <select class="form-select" id="editTipoGasto" name="tipoGasto" required>
                                                <option value="">Seleccione una opción:</option>
                                                <option value="operativo">Operativo</option>
                                                <option value="administrativo">Administrativo</option>
                                                <option value="mantenimiento">Mantenimiento</option>
                                        ...
                                        <div class="mb-3">
                                            <label for="editDetalle" class="form-label fw-bold">Detalle:</label>
